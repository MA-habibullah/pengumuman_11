	...
	<div class="container">
			...
			?>
			    ...
			    <tr><td>Password</td><td><?php echo $data['jk']; ?></td></tr> -->
					...
					<div class="alert alert-success" role="alert" style="text-align:justify;"><strong>
						...
						<ol>
							<font size="3">
								<li value="1"> Pengambilan Surat Keterangan Lulus dan Raport dilaksanakan mulai hari Selasa, 6 Mei 2025 mulai pukul 09.00 wib., sesuai jadwal yang telah ditentukan. </li>
						...
						<ol>
							<font size="3">
								<li value="1">Selasa, 6 Mei 2024 : Kelas 12 1.1, 12 1.2, 12 1.3, 12 1.4 dan 12 2.1,</li>
				...
				?>
					...
					<p>
						Peserta didik yang dapat melihat pengumuman ini<br>
						adalah Peserta Didik SMAN 11 SURABAYA<br>
					...
					<form method="post">
						...
						<div class="d-grid">
			</br><button class="btn btn-primary" type="submit" name="submit">Periksa</button>
						</div>
					</form>
					</div>
		...
		<footer class="footer">
			<div class="container-fluid">
				<p class="text-muted text-center m-0 py-3">&copy; 2024 · SMA NEGERI 11 SURABAYA</p>
			</div>
		</footer>

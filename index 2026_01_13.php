...
$start_time = strtotime('2025-02-02 15:30:00');
$current_time = time();
            ...
            ?>
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                                <font size="3"><?php echo $data['nisn']; ?></font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <font size="3"><?php echo $data['kelas']; ?></font>
                            </td>
                        </tr>
                    </table>
                    <table class="table table-bordered">
                ...
                <div class="container my-4">
                    <p>Peserta didik SMAN 11 SURABAYA Tahun Ajaran 2024/2025 dapat melihat pengumuman ini.</p>
                    <p>Masukkan NISN:</p>
                    <form method="post">
